...
Larm supports five monitor types. Each type has its own configuration, but they all share common settings for check intervals, timeouts, and incident confirmation.
...
| **Confirm down** | 1 min | Minutes of consecutive failures before marking as down |
| **Confirm up** | 3 min | Minutes of consecutive successes before marking as recovered |
