---
title: "Update disruption"
authMethod: "bearer"
api: "PATCH /api/v1/disruptions/{id}"
description: "Updates a disruption — change fields, add a timeline entry, publish to a status page, or resolve"
---
