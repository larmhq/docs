...
The Larm CLI lets you manage monitors, alerts, status pages, incidents, and webhooks from your terminal. Open source at [github.com/larmhq/larm-cli](https://github.com/larmhq/larm-cli).
